...
'''
from numpy import var, mean, zeros, sqrt, size, min, logical_and, median, logical_or, \
shape, array, copy, nanmax, nanmin, delete, append
from meg import sensors
from meg.fftmeg import nearest
from pdf2py import channel, pdf
