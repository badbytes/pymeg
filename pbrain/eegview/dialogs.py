...
from pbrain.pbrainlib.gtkutils import str2num_or_err, donothing_callback, \
...
class SpecProps(gtk.Dialog):
    def __init__(self):
        ...
        e.show()
        self.entryFMin = e
        #table.attach(l, 0, 1, 0, 1, xoptions=gtk.FALSE, yoptions=gtk.FALSE)
        #table.attach(e, 1, 2, 0, 1,xoptions=gtk.TRUE, yoptions=gtk.FALSE)
        table.attach(l, 0, 1, 0, 1)#, xoptions=gtk.FALSE, yoptions=gtk.FALSE)
        table.attach(e, 1, 2, 0, 1)#,xoptions=gtk.TRUE, yoptions=gtk.FALSE)
