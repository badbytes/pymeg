...
from pbrain.loc3djr.GtkGLExtVTKRenderWindowInteractor import GtkGLExtVTKRenderWindowInteractor

from matplotlib.numerix import array, take, cross_correlate, fromstring, arange, Int16, Float, log10

from pbrain.pbrainlib.gtkutils import error_msg, simple_msg, make_option_menu,\
